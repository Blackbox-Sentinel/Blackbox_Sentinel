...
const uint8_t TRUSTED_PUB_KEY[32] = {
    0x9a, 0x9, 0x30, 0x59, 0x6b, 0xc1, 0xa6, 0x4a, 0x29, 0xe7, 0x7e, 0xc6, 0x48, 0x49, 0x6e, 0x48, 0xcf, 0xf3, 0xe9, 0xe7, 0xa2, 0xa7, 0xcc, 0xc1, 0x91, 0x35, 0x74, 0x41, 0x37, 0xd6, 0xa8, 0x70
};
