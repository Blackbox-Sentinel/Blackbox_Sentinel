...
try:
    ...
    print("[*] Uploading kiosk_ui.py via SFTP...")
    sftp.putfo(io.BytesIO(kiosk_code.encode('utf-8')), '/home/admin/kiosk_ui.py')
    
    print("[*] Uploading .xinitrc via SFTP...")
    sftp.putfo(io.BytesIO(xinitrc_code.encode('utf-8')), '/home/admin/.xinitrc')
