...
# Create the GUI launch script (.xinitrc)
...
# Launch a simple Python Tkinter fullscreen UI
...
# Exit on touch to let them know it works
def exit_app(event):
    root.destroy()
...
client.exec_command("chmod +x /home/admin/.xinitrc")
